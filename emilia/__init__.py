...
if ENV:
	...
	DONATION_LINK = os.environ.get('DONATION_LINK','t.me/Danuma_admin_bot')
	...
	API_WEATHER = os.environ.get('API_OPENWEATHER', '19fc11271a958183a1ccd8dad2fe7c82')
	...
	DEWMI_IMG = os.environ.get('DEWMI_IMG', 'https://telegra.ph/file/d16beb00ebe1c13df3de3.jpg')
	MAPS_API = os.environ.get('MAPS_API', None)	       
	TEMPORARY_DATA = os.environ.get('TEMPORARY_DATA', None)
	SPAMWATCH_TOKEN = os.environ.get('SPAMWATCH_TOKEN', 'kFaGmFPYSPoNlfttT2BIlI1rodSXGJ6Hn6~X~eHq1EbjQHYMw87eAnaE8N~WWZRR')
	WALL_API = os.environ.get('WALL_API', None)
	CASH_API_KEY = os.environ.get('CASH_API_KEY', None)
	TEMP_DOWNLOAD_DIRECTORY = os.environ.get("TEMP_DOWNLOAD_DIRECTORY", "./")
	TIME_API_KEY = os.environ.get('TIME_API_KEY', '4BR7R7IOXZ4G')
