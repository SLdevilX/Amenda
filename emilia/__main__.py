...
from emilia import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, spamcheck, DEWMI_IMG
    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                ...
                [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/danuma01"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/D_bot_Ai")],
                [InlineKeyboardButton(text="❓ Help", url="https://t.me/{}?start=help".format(context.bot.username)), InlineKeyboardButton(text="💖 About Developer", url="https://t.me/Danuma_admin_bot")],
                [InlineKeyboardButton(text="🎉 Add me to your group", url="https://t.me/{}?startgroup=new".format(context.bot.username))]])
            update.effective_message.reply_photo(DEWMI_IMG,
